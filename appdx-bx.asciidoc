...
== Sumcoin Explorer (bx) Commands

((("Sumcoin Explorer (bx) commands", id="BX18_1", range="startofrange")))Sumcoin Explorer (bx) is a command-line tool that offers a variety of commands for key management and transaction construction. It is part of the libbitcoin bitcoin library.
...
For more information, see the https://github.com/libbitcoin/libbitcoin-explorer[Sumcoin Explorer homepage] and https://github.com/libbitcoin/libbitcoin-explorer/wiki[Sumcoin Explorer user documentation].

=== Examples of bx Command Use

Let's look at some examples of using Sumcoin Explorer commands to experiment with keys and addresses.
